...
function emitirNota() {
  ...
  const desconto10 = 0.1; //Constante com o valor de desconto de 10%

  if (valorTotal > 100) {
    //Verifica o valor total do itens no array
  ...
  respostaValorDesconto.innerHTML =
    "Desconto: " +
